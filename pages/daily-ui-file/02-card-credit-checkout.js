  ...
  <Layout title="002 Card Credit Checkout">
    <Container>
      ...
      <ListItem>
          <Meta>Website</Meta>
          <span>
            <Link href="https://www.figma.com/design/9Er8M1VBtURPgOwM5QOiYj/DailyUI-Challenge?node-id=27-213" target="_blank">
      ...
      <AspectRatio maxW="640px" ratio={1.7} my={4}>
        <iframe
          src="/images/works/newshowcasetravelamoble.mp4"
          title="video player"
