  ...
  return (
    <Layout title="HitCoffee - Coffee Shop App">
      <Container>
        ...
        <P>
          The HitCoffee app aims to change all this by offering users a quick
          and efficient way to browse the menu and the place orders as per
          their preferences in their most liked drinks along with the
          accompanying snacks and also to stay connected with their local coffee
          shop. HitCoffee app which is very user-friendly on your mobile device
          allows us to get you the coffee you desire within a half- a-second,
          allowing you to move on with your life and prepare for a better day
          with your regular-priced coffee. HitCoffee Never Ending Fresh Brewed
        ...
        <List ml={4} my={4}>
          <ListItem>
            ...
            <span>
              <Link
                href="https://www.behance.net/gallery/202629391/Coffee-Shop-UIUX-Design"
                target="_blank"
              >
                https://www.behance.net/gallery/202...{' '}
          ...
          <ListItem>
            <Meta>Setup</Meta>
            <span>Figma, ArtBoard, Flaticon.</span>
          </ListItem>
          <ListItem>
        ...
        {isDesktop && ( // Render iframe only if isDesktop is true
